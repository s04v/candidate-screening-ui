...
export function CandidateTable(props) {
    ...
    const analyze = async (e, candidateId) => {
        ...
        backend.post(`/analyze`, analyzeData)
            .then(res => {
                ...
                const index = candidates.findIndex(c => c._id === candidateId);
    ...
    return <div className={style.root}>
        <table>
            <tr class="head">
                <th align="start" style={{ width: '22%'}}>Name</th>
                <th align="start" style={{ width: '22%'}}>Created Date</th>
                <th align="start" style={{ width: '22%'}}>Source</th>
                <th align="start" style={{ width: '22%'}}>Score</th>
                <th align="start" style={{ width: '22%'}}></th>
            </tr>
                ...
                <tr class="tableRow" >
                    ...
                    <td>
                        ...
                        <div>
                            ...
                            <button id="analyzeButton" onClick={(e) => analyze(e, item._id)}>Analyze</button>
                        </div>}
                    </td>
                </tr>
            </>) : ""}
